...
//        {
//            SaveFileAsString("c:\\pop.txt", s);
//            return PopTextFile("c:\\pop.txt");
//        }
...
//                s += "0" + DateTime.Now.Hour.ToString();
//            else
...
//                s += "0" + DateTime.Now.Minute.ToString();
//            else
...
//        //{
//        //    String[] s = Tools.Strings.Split(strIn, strSplit);
//        //    return ToArray(s);
//        //}
...
//        //{
//        //    Tools.FileSystem.Shell("explorer", strFolder);
//        //    return;
//        //}
...
//        //    Tools.Files.SaveFileAsString(strFile, "test");

//        //    String strD = Tools.Files.OpenFileAsString(strFile);
...
//        //    foreach (String s in a)
//        //    {
//        //        if (Tools.Strings.StrCmp(s, strStart))
//        //            return true;
//        //    }
//        //    return false;
//        //}
...
//        //{
//        //    if (Tools.Strings.StrCmp(Tools.Strings.Left(strIn.Trim(), strFront.Length), strFront))
...
//                if (length > 0)
//                    return Tools.Strings.Left(st, length);
//                else
//                    return st;
//            }
//            catch (Exception)
...
//                return s;
//            else
//                return Tools.Strings.Right("00" + t.Hours.ToString(), 2) + ":" + s;
//        }
...
//        {
//            return Tools.Strings.Right("0" + s, 2);
//        }
...
//        //    if (strEnd.Length == 0)
//        //        return Tools.Strings.Mid(strLine, lngMark);
...
//        //    //top line
//        //    if (Tools.Strings.StrCmp(Tools.Strings.Left(strText, s.Length + 2), s + "\r\n"))
//        //        return true;

//        //    //bottom line
//        //    if (Tools.Strings.StrCmp(Tools.Strings.Right(strText, s.Length + 2), "\r\n" + s))
//        //        return true;

...
namespace Core
{
    public abstract class Report : ReportSection
    {
        ...
        public bool TotalsOnTop = false;
        public ReportSection FooterSection;
        ...
        public void Calculate(Context context, ReportArgs args)  //this defines the report calc structure and shouldn't be virtual
        {
            BeforeCalculate(context, args);
            CalculateLines(context, args);
            AfterCalculate(context, args);
        }
        public virtual void BeforeCalculate(Context context, ReportArgs args)
        {
        ...
        public virtual void AfterCalculate(Context context, ReportArgs args)
        {
            CalculateAutoTotals(context);
        }
        void CalculateAutoTotals(Context context)
        {
        ...
        void CalculateAutoTotal(Context context, ReportTotal t)
        {
            t.Value = 0;
        ...
        public virtual ReportTargetHtml GetReportTargetHtml()
        {
            return new ReportTargetHtml(true);
        }
        protected ReportTotal AutoTotal(String columnCaption)
        {
            return AutoTotal("", columnCaption);
        }
        ...
        public void SummarizeByDate(Context context, ReportArgs args, String dateCriteriaUid)
        {
        ...
        public void SummarizeByDate(Context context, ReportArgs args, ReportCriteriaDateRange range)
        {
        ...
        public void SummarizeByRadio(Context context, ReportArgs args, String dateCriteriaUid)
        {
        ...
        public void SummarizeByRadio(Context context, ReportArgs args, ReportCriteriaRadio radio)
        {
        ...
        public void SummarizeByColumn(Context context, ReportArgs args, int columnIndex)
        {
        ...
        public void SortByColumnIndex(int colIndex)
        {
            ...
            if (this.Sections.Count > 0)
            {
                ...
                {
                    kvp.Value.Lines.Sort(comp);
                }
            }
        }
        public void InferColumnOptions(Context context)
        {
        ...
        public virtual void ProcessCommand(Context context, String command)
        {
        ...
        //public void SummarizeByCompany(Context context, ReportArgs args, ReportCriteriaCompany company)
        //{
    ...
    public class ReportArgs
    {
        ...
        public ReportArgs(Context context)
        {
        }
        public virtual bool ValidCheck(Context context)
        {
            return true;
        }
        ...
        public ReportArgs Clone(Context context)
        {
    ...
    public abstract class ReportCriteria
    {
        ...
        public abstract void ApplyTo(Context context, ReportCriteria c);
    ...
    public class ReportCriteriaDateRange : ReportCriteria
    {
        ...
        public bool AllowBeforeAfter = true;
        public bool AllowBetween = true;
        public bool AllowYearToDate = true;
        public bool AnyIsNone = false;
        public bool HideEndDate = false;
    ...
    public class ReportCriteriaAgent : ReportCriteria
    {
        ...
        public bool OnlyActiveSalespeople = false;
    ...
    public class ReportCriteriaAgentMany : ReportCriteria
    {
        public List<String> AgentIds = new List<string>();
        public bool OnlyActiveSalespeople = false;

        public ReportCriteriaAgentMany(String caption)
            : base(caption)
        {
        }
        public override bool Exists()
        ...
        public override void ApplyTo(Context context, ReportCriteria c)
        {
            ((ReportCriteriaAgentMany)c).AgentIds.AddRange(AgentIds);
        }
        public override bool Matches(ReportCriteria c)
        {
            ReportCriteriaAgentMany cc = ((ReportCriteriaAgentMany)c);
            if (cc.AgentIds.Count != AgentIds.Count)
                return false;
            foreach (String s in AgentIds)
            {
    ...
    public class ReportColumn
    {
        ...
        public bool ShowHyperLink = true;
    ...
    public class ReportLine
    {
        ...
        public ReportCell SetInc(Object compareValue, String displayValue, Color color)
        {
            NextIndex++;
            return Set(NextIndex, compareValue, displayValue, color);
        }
        ...
        public ReportCell SetIncBlankZero(Double value, String command = "")
        {
            String display = "";
            if (value != 0)
                display = Tools.Number.MoneyFormat(value);
            return SetInc(value, display, null, command: command);
        }
    ...
    public class ReportTotal
    {
        ...
        //KT Allow Caption and Value in Caption
        public bool CombineCaptionValue;
        ...
        public virtual object RenderExcel()
        {
            if (IncludeDecimals)
                return Value;
            else
    ...
    public class ReportTotalPercent : ReportTotal
    {
        ...
        public override object RenderExcel()
        {
            ValueUse = Tools.Database.ValueUse.Percentage;
            if (IncludeDecimals)
                return Value / 100;
            else
    ...
    public class ReportTarget
    {
        ...
        public virtual void Render(Context context, Report r)
        {
            try
            {
                RenderHeading(r);
        ...
        {
            if (r.FooterSection != null)
                RenderSection(r, r.FooterSection, true);
        }
        protected virtual void RenderSubReports(Context context, Report r)
        {
        ...
        public virtual void Show(Context context, Report r)
        {
    ...
    public class ReportTargetHtml : ReportTarget
    {
        ...
        protected virtual void RenderColumnHeader(Report r, ReportColumn c)
        {
            ...
            if (c.Alignment == ColumnAlignment.Right)
                ...
                align = " align=\"center\"";
            else if (c.Alignment == ColumnAlignment.Left)
                align = " align=\"Left\"";
        ...
        public override void AddDataTable(string strCaption, DataTable d, ArrayList aligns, ArrayList formats)
        {
            ...
            Write(DataConnection.ConvertDataTableToHTML(d, formats, aligns, "", false));
        }
        ...
        protected override void RenderTotals(Report r, ReportSection section)
        {
            ...
            foreach (ReportTotal t in section.Totals)
            {
                if (t.CaptionColumn > -1)
                {
                    ...
                    if (!t.CombineCaptionValue)
                        cells[t.CaptionColumn] = "<td" + line_style + "><span class=\"rz-report\"><b>" + t.Caption + "</b></span></td>";
                    else
                        cells[t.CaptionColumn] = "<td " + line_style + "><span class=\"rz-report\"><b>" + t.Caption + " $" + Number.MoneyFormat(t.Value) + "</b></span></td>";
                }
                ...
                if (t.ValueColumn > -1)
                {
                    ...
                    cells[t.ValueColumn] = "<td align=\"right\" " + line_style + ">" + (t.BoldFont ? "<b>" : "") + colorPre + "<span class=\"rz-report\">" + t.Render() + "</span>" + colorPost + (t.BoldFont ? "</b>" : "") + "</td>";
                }
            }
            Write("<tr>");
        ...
        public override void Show(Context context, Report r)
        {
            base.Show(context, r);
            context.TheLeader.ShowHtml(context, r.Caption, HtmlResult);
        }
    ...
    public class ReportTargetExcel : ReportTarget
    {
        ...
        protected String SheetName
        {
            get
            {
                return "Sheet" + SheetNumber.ToString();
            }
        }
        ...
        protected override void RenderTotals(Report r, ReportSection section)
        {
            ...
            try
            {
                foreach (ReportTotal t in section.Totals)
                {
                    ...
                    worksheet.Cells[xlRow, t.ValueColumn + 1].Value = t.RenderExcel();
                    worksheet.Cells[xlRow, t.ValueColumn + 1].Style.Numberformat.Format = GetCellFormat(t.Value, "");
                }
            }
            catch { }
        }
        ...
        protected override void RenderSubReports(Context context, Report r)
        {
            foreach (Report subReport in r.SubReports)
            {
                BeginSheet(NextSheet());
                Render(context, subReport);
            }
        }
    ...
    public class ReportSqlDateRange : Report
    {
        ...
        public ReportSqlDateRange(Context context)
            : this(context, "", "", "", new Tools.Dates.DateRange())
        {
        }
        public ReportSqlDateRange(Context context, String title, String sql, String dateField, Tools.Dates.DateRange range)
            : base(context)
        {
            Sql = sql;
            DateField = dateField;
        ...
        protected override void ApplyTo(Context context, Report r)
        {
        ...
        String GenerateSql(Context context, ReportSqlDateRangeArgs argsx, bool structureOnly)
        {
            String sql = Sql;
    ...
    public class ReportSqlDateRangeArgs : ReportArgs
    {
        ...
        public ReportSqlDateRangeArgs(Context context)
            : this(context, new Tools.Dates.DateRange())
        {

        }
        public ReportSqlDateRangeArgs(Context context, Tools.Dates.DateRange initialRange)
            : base(context)
        {

...
//    {
//        public Core.Report Report;
//        public ChartType ChartType;

//        public void Init(Core.Report report, ChartType chartType)
//        {
//            Report = report;
//            ChartType = chartType;
//            Change();
...
//                    break;
//                case RzWeb.Controls.ChartType.Pie:
...
//        public static void RenderPie(StringBuilder sb, Chart c, String targetDiv, String sectionId, String onClick)
//        {
//            RenderPie(sb, targetDiv, sectionId, onClick, c.Series[0]);
//        }

//        public static void RenderPie(StringBuilder sb, String targetDiv, String sectionId, String onClick, ChartSeries series)
//        {
...
//        public static void RenderBar(StringBuilder sb, Spot actionSpot, Chart c, String targetDiv, String sectionId, String onClick)
//        {
//            String id = Tools.Strings.GetNewID();
//            RenderChartStart(sb, id);
//            sb.AppendLine("	    chart: {");
...
//            //sb.AppendLine("            text: 'Source: WorldClimate.com'");
//            //sb.AppendLine("        },");
//            sb.AppendLine("        xAxis: [{");
...
//                    if (pointIndex > 0)
//                        sb.Append(", ");
//                    //sb.Append(Math.Round(p.Y, 2).ToString());
...
//            //sb.AppendLine("            color: '#89A54E',");
//            //sb.AppendLine("            type: 'spline',");
//            //sb.AppendLine("            data: [7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]");
//            //sb.AppendLine("        }");

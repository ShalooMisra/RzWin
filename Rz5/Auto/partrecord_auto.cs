...
namespace Rz5
{
    [CoreClass("partrecord")]
    public partial class partrecord_auto : NewMethod.nObject
    {
        static partrecord_auto()
        {
            Item.AttributesCache(typeof(partrecord_auto), AttributeCache);
        }
        ...
        [CoreVarVal("alternatepart", "String", TheFieldLength = 255, Caption = "Alternate Part", Importance = 21)]
    ...
    public partial class partrecord
    {
        public static partrecord New(Context x)
        { return (partrecord)x.Item("partrecord"); }

        public static partrecord GetById(Context x, String uid)
        { return (partrecord)x.GetById("partrecord", uid); }

        public static partrecord QtO(Context x, String sql)
        { return (partrecord)x.QtO("partrecord", sql); }
    }
}

...
namespace Rz5
{
    [CoreClass("consignment_manifest")]
    public partial class consignment_manifest_auto : NewMethod.nObject
    {
        static consignment_manifest_auto()
        {
            Item.AttributesCache(typeof(consignment_manifest_auto), AttributeCache);
        }
        ...
        [CoreVarVal("list_acquisition_agent", "String", TheFieldLength = 100, Caption = "list_acquisition_agent", Importance = 143)]
        public VarString list_acquisition_agentVar;

        [CoreVarVal("list_acquisition_agent_uid", "String", TheFieldLength = 100, Caption = "list_acquisition_agent_uid", Importance = 144)]
        public VarString list_acquisition_agent_uidVar;



        public consignment_manifest_auto()
        {
            StaticInit();
    ...
    public partial class consignment_manifest
    {
        public static consignment_manifest New(Context x)
        { return (consignment_manifest)x.Item("consignment_manifest"); }

        public static consignment_manifest GetById(Context x, String uid)
        { return (consignment_manifest)x.GetById("consignment_manifest", uid); }

        public static consignment_manifest QtO(Context x, String sql)
        { return (consignment_manifest)x.QtO("consignment_manifest", sql); }
    }
}

...
namespace Rz5
{
    public class ImportRz3
    {
        ...
        public void ImportOrddetLines(ContextRz context, int year)
        {
            DateTime start = DateTime.Now;
            context.TheLeader.CommentEllipse("Starting the import process");
            bool recall = context.xSys.Recall;
        ...
        public void ImportFinish(ContextRz context)
        {
            ...
            ImportDeductions(context, Tools.Dates.NullDate, Enums.OrderType.Invoice);
            ImportDeductions(context, Tools.Dates.NullDate, Enums.OrderType.Purchase);
            ImportDeductions(context, Tools.Dates.NullDate, Enums.OrderType.Service);
        ...
        public void ImportNowTo2009(ContextRz context)
        {
            DateTime start = DateTime.Now;
            context.TheLeader.CommentEllipse("Starting the import process");
            bool recall = context.xSys.Recall;
            ...
            {                
                context.TheLeader.CommentEllipse("Processing year " + i.ToString());
                context.TheLeader.Comment("Processing year " + i.ToString());
                if (!ImportDetailLines(context, i))
                    ret = false;
            }
            if (recall)
                context.xSys.Recall = true;
            ...
            if (!ret)
                throw new Exception("The import failed: " + total_time);
            context.TheLeader.Tell("Done: " + total_time);
        }
        public void Import2009To2005(ContextRz context)
        {
            DateTime start = DateTime.Now;
            context.TheLeader.CommentEllipse("Starting the import process");
            bool recall = context.xSys.Recall;
        ...
        public bool ShowDetailTables(ContextRz context)
        {
            context.TheLeader.CommentEllipse("Showing detail tables");
            foreach (String s in DetailTables)
            {
        ...
        public bool ShowDetailTable(ContextRz context, String table)
        {
        ...
        public void SwitchTemplateFields(ContextRz context)
        {
        ...
        public void ResetReorgFlags(ContextRz context)
        {
            foreach (String s in DetailTables)
            {
        ...
        public string LinkSingleLine(ContextRz context, orddet_line l, String type, String old_order_id)
        {
        ...
        public bool ImportServices(ContextRz context)
        {
        ...
        public bool HideDetailTables(ContextRz context)
        {
        ...
        public bool HideDetailTable(ContextRz context, String table)
        {
            if (!context.TableExists(table))
                return true;
        ...
        public void ImportDeductions(ContextRz context, DateTime start_cutoff)
        {
            context.TheLeader.StartPopStatus("Importing charges...");
            ImportDeductions(context, start_cutoff, Enums.OrderType.Invoice);
            ImportDeductions(context, start_cutoff, Enums.OrderType.Purchase);
            ImportDeductions(context, start_cutoff, Enums.OrderType.Service);
            context.TheLeader.Comment("Done.");
            context.TheLeader.StopPopStatus(true);
        }
        public void ResSaveAllOrderInstances(ContextRz context)
        {
            //ReSave Orders To Update Colors
            context.TheLeader.Comment("ReSaving [ordhed_quote]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_quote", true);
            context.TheLeader.Comment("ReSaving [ordhed_rfq]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_rfq", true);
            context.TheLeader.Comment("ReSaving [ordhed_sales]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_sales", true);
            context.TheLeader.Comment("ReSaving [ordhed_purchase]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_purchase", true);
            context.TheLeader.Comment("ReSaving [ordhed_invoice]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_invoice", true);
            context.TheLeader.Comment("ReSaving [ordhed_rma]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_rma", true);
            context.TheLeader.Comment("ReSaving [ordhed_vendrma]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_vendrma", true);
            context.TheLeader.Comment("ReSaving [ordhed_service]");
            SysNewMethod.UpdateAllByClass(context, "ordhed_service", true);
            context.TheLeader.CommentEllipse("Hiding the detail tables");
            context.TheLeader.Comment("Hiding the detail tables");
        }
        //Private Functions
        private bool ImportDetailLines(ContextRz context, int year)
        {
            try
            {
                ...
                {
                    context.TheLeader.Comment("Processing Sales Order " + i.ToString() + " of " + sales_ids.Count.ToString() + " for year: " + year.ToString());
                    i++;
        ...
        private void ImportDetailLineSales(ContextRz context, DataRow r)
        {
            try
            {
                    ...
                    switch (c.Caption)
                    {
                        ...
                        default:
                            ...
                            if (c.Caption == "requireddate")
                            {
                                ...
                                if (x != null && x != DBNull.Value)
                                    l.customer_dock_date  = nData.NullFilter_DateTime(x);
                                break;
                            }                            
                            try
                            {
                ...
                if (l.StockType == Enums.StockType.Buy && Tools.Strings.StrExt(l.vendor_uid))
        ...
        private void AbsorbLine(ContextRz context, orddet_line l, String type, DataRow r)
        {
            ...
            switch (type)
            {
                case "purchase":
                    ...
                    {
                        l.was_received = true;
                        l.Status = Enums.OrderLineStatus.Open;
                    }
                    ...
                    break;
                case "invoice":
                    l.Status = Enums.OrderLineStatus.Packing;
                    l.was_invoice = true;
                    ...
                    {
                        l.was_shipped = true;
                        l.Status = Enums.OrderLineStatus.Shipped;
                    }
                    ...
                    break;
                case "rma":
                    l.Status = Enums.OrderLineStatus.RMA_Receiving;
                    l.was_rma = true;
                    ...
                    if (l.quantity_unpacked_rma > 0 && l.quantity_unpacked_rma == l.quantity)
                    {
                        ...
                        l.Status = Enums.OrderLineStatus.RMA_Received;
                    }
                ...
                case "vendrma":
                    ...
                    if (l.quantity_packed_vendrma > 0 && l.quantity_packed_vendrma == l.quantity)
                    {
                        ...
                        l.Status = Enums.OrderLineStatus.Vendor_RMA_Shipped;
                    }
                ...
                case "service":
                    ...
                    if (l.Status == Enums.OrderLineStatus.Hold || l.Status == Enums.OrderLineStatus.Any)
                        l.Status = Enums.OrderLineStatus.Out_For_Service;
                    ...
                    if (l.quantity_unpacked_service > 0)
                    {
                        if (l.Status == Enums.OrderLineStatus.Out_For_Service)
                            l.Status = Enums.OrderLineStatus.Received_From_Service;
        ...
        private void ImportDeductions(ContextRz context, DateTime start_cutoff, Enums.OrderType t)
        {
        ...
        private void ReOrderDetailLines(ContextRz context)
        {
            ...
            {
                o++;
                context.TheLeader.Comment("Processing Sales Order " + o.ToString() + " of " + a.Count.ToString());
            ...
            {
                o++;
                context.TheLeader.Comment("Processing Purchase Order " + o.ToString() + " of " + a.Count.ToString());
                if (!Tools.Strings.StrExt(s))
                    continue;
            ...
            {
                o++;
                context.TheLeader.Comment("Processing Invoice " + o.ToString() + " of " + a.Count.ToString());
                if (!Tools.Strings.StrExt(s))
                    continue;
            ...
            {
                o++;
                context.TheLeader.Comment("Processing RMA " + o.ToString() + " of " + a.Count.ToString());
                if (!Tools.Strings.StrExt(s))
                    continue;
            ...
            {
                o++;
                context.TheLeader.Comment("Processing VendRMA " + o.ToString() + " of " + a.Count.ToString());
                if (!Tools.Strings.StrExt(s))
                    continue;
            ...
            {
                o++;
                context.TheLeader.Comment("Processing Service " + o.ToString() + " of " + a.Count.ToString());
                if (!Tools.Strings.StrExt(s))
                    continue;
        ...
        private void ReindexDatabase(ContextRz context)
        {
            try
            {
    ...
    class FieldSwitch
    {
        ...
        public FieldSwitch(String field_old, String field_new) : this("", field_old, field_new)
        {

...
{
    public partial class ReconcileAccountCC : UserControl
    {
        //Private Variables
        ReconcileArgs Args;
        account Account;
        ...
        double ClearedBal
        {
            get
            {
                return PayClear + DepClear + Args.BeginAmount + Args.ServiceArgs.Amount;
            }
        }
        double Difference
        {
        ...
        private void SetStartNumbers()
        {
            ...
            lblFinanceAmount.Text = "-" + Tools.Number.MoneyFormat(Args.ServiceArgs.Amount);
